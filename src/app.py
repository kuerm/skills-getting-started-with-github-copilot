...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice drills and compete in friendly soccer matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["maria@mergington.edu", "liam@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Train for inter-school basketball tournaments",
    ...
    "Drama Club": {
        "description": "Rehearse and perform plays, improv, and stage workshops",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["mia@mergington.edu", "jack@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Work on challenging math problems and compete in contests",
        "schedule": "Mondays, 3:30 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "emma@mergington.edu"]
    },
    "Science Club": {
        "description": "Run experiments and explore STEM topics through projects",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
